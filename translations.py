def get_text(lang):
    if lang == "Urdu":
        return {
            ...
            "advance": "ایڈوانس",
            "rem": "باقی رقم",
            "pay_mode": "ادائیگی کا طریقہ",
            "del_date": "ڈیلیوری کی تاریخ",
            "meas": "پیمائش (Measurements)",
            "styles": "ڈیزائن اور اسٹائل",
            "save": "آرڈر سیو کریں",
            "verbal": "زبانی ہدایات (Special Notes)",
            "extra": "اضافی ضرورت",
            # Measurements
            ...
            "kur_slv": "کرمہ آستین", "round": "گول دامن", "square": "چکور دامن",
            "fit": "فٹنگ", "double": "ڈبل سلائی", "gum": "گم سلائی"
        }
    else:
        return {
    ...
    if lang == "Urdu":
        return {
            ...
            "shop": "دکان کا نام", "s_q": "سیکیورٹی سوال (بچپن کا دوست؟)", "s_a": "جواب",
        ...
        return {
            ...
            "shop": "Shop Name", "s_q": "Security Question (Best Friend?)", "s_a": "Answer",

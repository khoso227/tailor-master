...
def get_connection():
    # Database version 11
    return sqlite3.connect('tailor_master_v11.db', check_same_thread=False)
...
def init_db():
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS clients 
        (id INTEGER PRIMARY KEY AUTOINCREMENT, user_id INTEGER, name TEXT, phone TEXT, 
         ...
         m_data TEXT, s_data TEXT, extra_req TEXT, verbal_notes TEXT, status TEXT DEFAULT 'Pending')''')
